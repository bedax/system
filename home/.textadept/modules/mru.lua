-- from: https://github.com/gabdub/ta-tweaks/blob/master/modules/ctrl_tab_mru/
...
-- from: https://github.com/gabdub/ta-tweaks/tree/master/modules/util/
local Util = {}

Util.goto_view = function(numview)
...
M.handler = mru_ctrl_tab_handler
